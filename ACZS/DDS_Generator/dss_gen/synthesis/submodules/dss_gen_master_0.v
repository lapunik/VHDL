...
// 
// Generated using ACDS version 13.0sp1 232 at 2020.03.09.15:05:42

`timescale 1 ps / 1 ps
module dss_gen_master_0 #(
		parameter USE_PLI     = 0,
	...
	dss_gen_master_0_timing_adt timing_adt (
		.clk       (clk_clk),                                    //   clk.clk
	...
	dss_gen_master_0_b2p_adapter b2p_adapter (
		.clk               (clk_clk),                              //   clk.clk
		.reset_n           (~rst_controller_reset_out_reset),      // reset.reset_n
	...
	dss_gen_master_0_p2b_adapter p2b_adapter (
		.clk               (clk_clk),                            //   clk.clk
		.reset_n           (~rst_controller_reset_out_reset),    // reset.reset_n
